    ...
    <div>
      ...
      <section>
        ...
        <PaddingContainer>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 xl:place-items-center   gap-4 md:gap-5 md:mx-10  xl:gap-x-0 xl:mx-38    topPadding   ">
        ...
        <div className="relative  w-full h-[855px] justify-center items-center 2xl:mt-32   ">
